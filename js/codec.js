...
function parseShareableUrl(url) {
    let parameters = (new URL(url)).searchParams;
    if(!parameters.has("v")) throw "Failed to load script: No \'v\' query parameter found";
